...
class Model {
  ...
  static bulkCreate(records, options = {}) {
    ...
    if (options.onConflictUpdate !== undefined && options.onConflictUpdate.update && options.onConflictUpdate.update.columns) {
      if (_.isArray(options.onConflictUpdate.update.columns) && options.onConflictUpdate.update.columns.length) {
        options.onConflictUpdate.update.columns = _.intersection(
          _.without(Object.keys(this.tableAttributes), this._timestampAttributes.createdAt),
          options.onConflictUpdate.update.columns
        );
      } else {
